...
This contest is open for two weeks to give wardens time to understand the protocol properly. Submissions can only be made in the second week of the contest. Representatives from mochi.fi will be available in the Code Arena Discord to answer any questions during the contest period. The focus for the contest is to try and find any logic errors or ways to optimize gas costs for users interacting with the protocol and specifically with the Mochi CSSR as outline [here](#-CSSR)

## :bookmark_tabs: Protocol Overview

Mochi puts your long-tail assets to work as collateral while maintaining exposure to their long-term value.
